...
export function Administration() {
  ...
  return <main className="admin-page"><header className="admin-header"><a href="/">← Back to dashboard</a><span className="eyebrow">LOCAL / ADMINISTRATION</span><h1>Curate the inventory</h1><p>Safe metadata, approved media, and manual history. No login required.</p></header>
