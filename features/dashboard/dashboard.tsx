...
export function Dashboard() {
  ...
  return <div className="app-shell"><Sidebar collapsed={collapsed} onToggle={() => setCollapsed(!collapsed)} /><main className="main-content" id="dashboard"><header className="topbar"><div><span className="eyebrow">LOCAL / EDITORIAL CONTROL ROOM</span><h1>Project inventory</h1><p>Signal from the workbench, curated for fast discovery.</p></div><div className="topbar-actions"><a className="admin-link" href="/admin">Administration</a><div className="status-pill"><span />LOCAL API</div></div></header>
